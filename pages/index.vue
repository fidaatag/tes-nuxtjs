  ...
  <section class="relative overflow-hidden bg-white">
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div class="grid gap-5 row-gap-8 lg:grid-cols-2">
        ...
        <div class="flex flex-col justify-center">
          <div class="max-w-xl mb-6">
            ...
            <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
              ...
              that you
              <span class="inline-block text-purple-500">will love</span>
            </h2>
            <p class="text-base text-gray-700 md:text-lg">
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae. explicabo.
            </p>
          </div>
          <a href="/" aria-label="" class="inline-flex items-center font-semibold transition-colors duration-200 text-purple-500 hover:text-purple-800">
            Learn more
        ...
        <!-- image -->
        <div class="relative">
          <svg class="absolute w-full text-teal-200" fill="currentColor" viewBox="0 0 600 392">
          ...
          <svg class="relative w-full text-purple-500" fill="currentColor" viewBox="0 0 600 392">
