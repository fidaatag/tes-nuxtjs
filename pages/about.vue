    ...
    <div class="grid gap-5 row-gap-8 lg:grid-cols-2">
      <div class="flex flex-col justify-center">
        ...
        <div class="grid gap-5 row-gap-8 sm:grid-cols-2">
          <div class="bg-white border-l-4 shadow-sm border-purple-400">
      ...
      <div>
        <img class="object-cover w-full h-56 rounded shadow-lg sm:h-96" src="https://cdn.pixabay.com/photo/2021/02/02/08/41/graph-5973126_1280.jpg" alt="" />
      </div>
    </div>
  </section>
